...
class _desginState extends State<desgin> {
  bool s = true;
  Icon ikon = Icon(Icons.add_box_outlined);
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        IconButton(
                            onPressed: () {}, icon: const Icon(Icons.water)),
                        const Text("1L/month"),
                      ],
                    ),
                    Column(
                      children: [
                        IconButton(
                            onPressed: () {}, icon: const Icon(Icons.light)),
                        const Text("29C - 40C")
                      ],
                    ),
                    Column(
